...
var updateCart = function updateCart(icecream) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', icecream).then(function (res) {
    ...
    command: toastr__WEBPACK_IMPORTED_MODULE_1___default().success("Added to Cart");
  })["catch"](function (err) {
    command: toastr__WEBPACK_IMPORTED_MODULE_1___default().error("Something went wrong");
  });
};
